...
EVENTS_DATA_FILE = "new_alarms.csv"
...
WEATHER_DATA_FILE = "new_weather.csv"
...
df_weather_isw.to_csv(f"{OUTPUT_FOLDER}/data_pred.csv", sep=";", index=False)
